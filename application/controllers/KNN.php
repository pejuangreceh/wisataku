...
class KNN extends CI_Controller{
    ...
    public function index()
    {
        ...
        if($this->input->method()==='post'){
            ...
            return $this->load->view('admin/knn_output.php', $data);
        }
        return $this->load->view('admin/knn_input.php');
    }
    public function paket()
    {
        return $this->load->view('admin/knn_paket.php');
    }
    public function pilihan_paket($no)
    {
        return $this->load->view('admin/knn_pilih_paket.php');
    }
    public function destinasi($id)
    {
        $this->load->model('objek_wisata_model');
        $data['wisata'] = $this->objek_wisata_model->find($id);
        return $this->load->view('admin/knn_destinasi.php', $data);
    }
    public function map($koordinat)
    {
        $data['koordinat'] = $koordinat;
        return $this->load->view('admin/knn_map.php', $data);
    }
