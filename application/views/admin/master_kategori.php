          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                <?php if($isUser!==true){?>
                <a href="<?= site_url('admin/insert_kategori"') ?>" class="btn btn-primary float-end">+ Tambah Kategori</a>
                <?php } ?>
                  <div class="d-md-flex align-items-center">
                    <div class="col-12">
                      <h4 class="card-title">Data Kategori</h4>
                      <h5 class="card-subtitle">Tabel Kategori</h5>
                        ...
                        <tbody>
                          <?php $no=1;foreach($kategori as $kat){ ?>
                            <tr>
                              ...
                              <td><?= $kat->last_modified ?></td>
                              <td>
                                                        <a href="<?= site_url("admin/update_kategori").'/'.$kat->id ?>" class="btn btn-success">Update</a>
                                                        <a href="#" 
                                                            data-delete-url="<?= site_url('admin/delete_kategori/'.$kat->id) ?>" 
