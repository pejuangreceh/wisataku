                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <?php if($detail==null){ ?>
                        ...
                        <form class="form-horizontal" action="<?= site_url('admin/insert_detail') ?>" method="post">
                            <input type="text" name="id_objek_wisata" value="<?= $id_wisata ?>" hidden="hidden">
                            <div class="card-body">
                    ...
                    <?php } else { ?>
                        ...
                        <form class="form-horizontal" action="<?= site_url('admin/update_detail/'.$detail->id) ?>" method="post">
                            <input type="text" name="id_objek_wisata" value="<?= $detail->id_objek_wisata ?>" hidden="hidden">
                            <input type="text" name="id" value="<?= $detail->id ?>" hidden="hidden">
                            <div class="card-body">
                                <?php foreach($col as $key => $value){ ?>
                                <div class="form-group row">
                                    <label
