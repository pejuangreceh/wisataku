                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      ...
                      <!-- <?php echo $last_id->id; ?> -->
                      <form class="form-horizontal" action="<?= site_url('paket/update_paket_wisata/'.$id) ?>" method="post">
                          <div class="card-body">
                                    ...
                                    <?php foreach ($objek_wisata as $objek) {?>  
                                      ...
                                      <?php 
                                        foreach ($data_objek_wisata as $data_objek) {
                                          if($data_objek->id_objek == $objek->id){
                                            echo 'selected';
                                          }
                                        }
                                      ?>
                                      value="<?= $objek->id ?>"><?= $objek->nama_tempat ?></option>
                                    <?php } ?>
                                  </select>
                                </div>
                              </div>
                              <!-- <?php foreach ($data_objek_wisata as $data_objek) {?>  
                              <?php echo $data_objek->id; } ?> -->
                              <div class="form-group row">
                                <div class="col-sm-12">
                                  <div class="float-end">
                                    <div class="card-body">
